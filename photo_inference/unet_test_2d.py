...
path_out_folder = '/home/chaneu/unet'
path_out_folder_image = '/home/chaneu/unet/images'
path_out_folder_mask = '/home/chaneu/unet/masks'
path_out_folder_pred = '/home/chaneu/unet/preds'
...
model = torch.load('/home/chaneu/unet_model.pt')
...
for num, im in enumerate(images):
    ...
    tmp = torch.argmax(softmax(pred),axis=1)
    tmp = tmp.squeeze(0)
    ...
    cv2.imwrite(end_preds, pred_mask) #predicted mask
